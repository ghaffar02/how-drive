...
const faqDataByCategory: Record<string, FAQItem[]> = {
  'FAQ Homepage': [
    {
      id: 1,
  ...
  'FAQ Trainers': [
    ...
    },
    {
      ...
      englishQuestion: 'How do I enter my availability?',
      englishAnswer:
...
export default function FAQList({
  ...
  const faqData = faqDataByCategory[activeTab] || [];
        ...
        faqData.map((item, index) => (
          <React.Fragment key={item.id}>
            ...
            >
              ...
              <Box
                onClick={() => {
                  console.log('Delete FAQ:', item.id);
                }}
                sx={{
                  width: '20px',
                  height: '20px',
